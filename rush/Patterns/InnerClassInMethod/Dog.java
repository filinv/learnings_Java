    ...
    public Sayable toSayable(final int i) {
        class DogPet extends SuperDog implements Sayable{
            private String getName(){
                ...
                superName.append(getSuperQuotes()).append(name).append(getSuperQuotes());
            ...
            public String say() {
                ...
                if(i<1){
                    phrase.append(getName()).append(" спит.");
                } else {
                    phrase.append(getName()).append(" лает г");
                    for(int j=i;j>0;j--){
                        phrase.append('а');
                    }
                    phrase.append("в! ");
                    phrase.append(formatter.format(new Date()));
                }
